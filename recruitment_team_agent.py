...
def main() -> None:
    ...
    with st.sidebar:
        ...
        api_key = st.text_input("Gemini API Key", type="password", value=st.session_state.gemini_api_key, help="Get your API key from Google Cloud Console")
        ...
        required_configs = {
            'Gemini API Key': st.session_state.gemini_api_key,
